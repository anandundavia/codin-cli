...
const execute = async () => {
    try {
        ...
        const filesToCompress = [
            ...
            path.join(cwd, constants.fs.directory, constants.fs.coverageFinal), // coverage-final.json
            path.join(cwd, constants.fs.directory, constants.fs.coverageSummary), // coverage-summary.json
        ];
